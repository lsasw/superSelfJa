...
const aiSidebar = [
  ...
  },
  {
    ...
    children: [
      ...
      { text: "K 近邻", icon: "dot-circle", link: "21-K近邻" },
      { text: "朴素贝叶斯", icon: "envelope", link: "22-朴素贝叶斯" },
      { text: "K-Means 聚类", icon: "th", link: "23-K-Means聚类" },
      { text: "PCA 降维", icon: "compress", link: "24-PCA降维" },
      { text: "集成学习", icon: "layer-group", link: "25-集成学习" },
    ],
  },
  {
    text: "深度学习基础",
