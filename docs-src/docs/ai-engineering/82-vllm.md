...
vLLM 是目前 LLM 推理服务的首选方案，特别适合高并发场景。在下一篇文档中，我们将学习 TGI（Text Generation Inference），这是 HuggingFace 官方维护的另一个重要推理框架，与 vLLM 形成有力的补充和对比。

[下一篇：83-TGI 推理服务框架](83-tgi-inference.md)
